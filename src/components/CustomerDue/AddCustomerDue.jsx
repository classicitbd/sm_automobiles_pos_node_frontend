...
const AddCustomerDue = () => {
  ...
  const handleDataPost = async (data) => {
    ...
    //     `${BASE_URL}/customer_due?role_type=customer_payment_create`,
    //     {
    //       method: 'POST',
    //       credentials: 'include',
    //       headers: {
    ...
    //     toast.success(
    //       result?.message ? result?.message : 'Customer Due created successfully',
    //       {
    //         autoClose: 1000,
    //       }
    //     )
    //     refetch()
    //     setLoading(false)
    //     setCustomersDueCreateModal(false)
    //   } else {
