  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        secondary:
          'bg-secondary-400 text-text-default shadow-sm hover:bg-secondary-400/80',
        ghost: 'border hover:bg-accent hover:text-accent-foreground',
        link: 'text-text-default underline-offset-4 hover:underline',
        light:
          'text-primary bg-primaryVariant-50 border-primaryVariant-100 border hover:text-white hover:bg-primary/80',
      },
      size: {
